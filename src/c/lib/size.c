...
const char *SIZE_UNAVAILABLE_FONT[3] = {FONT_KEY_GOTHIC_24_BOLD, FONT_KEY_GOTHIC_28_BOLD, FONT_KEY_GOTHIC_28_BOLD};
const int16_t SIZE_UNAVAILABLE_WIDTH[3] = {100, 120, 120};
